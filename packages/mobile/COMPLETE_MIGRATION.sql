-- Attribute filtreleme ile gelişmiş arama fonksiyonu
...
COMMENT ON FUNCTION search_listings_with_attributes IS 'Gelişmiş arama fonksiyonu - attribute filtreleme ile birlikte';

-- Attribute arama için yardımcı fonksiyon
...
-- Fonksiyon için yorum ekle
COMMENT ON FUNCTION search_by_attribute_values IS 'Belirli attribute değerlerine göre arama yapar';

-- Attribute istatistikleri için fonksiyon
...
-- Fonksiyon için yorum ekle
COMMENT ON FUNCTION get_attribute_statistics IS 'Kategori bazında attribute kullanım istatistiklerini döndürür'; 