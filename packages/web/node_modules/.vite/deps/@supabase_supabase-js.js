...
var DEFAULT_HEADERS3 = { "X-Client-Info": `supabase-js/${version3}` };
...
var resolveFetch4 = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = async (...args) => await (await import("./browser-ponyfill-D5BZY2BT.js")).fetch(...args);
  } else {
    _fetch = fetch;
  }
  return (...args) => _fetch(...args);
