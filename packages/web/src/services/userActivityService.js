...
export const deleteUserActivity = async (activityId, userId) => {
...
export const addToListingHistory = (listingId) => {
  if (!listingId) return;
...
export const getListingHistory = () => {
  try {
...
export const saveLastSearch = (searchCriteria) => {
