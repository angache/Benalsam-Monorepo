...
export const checkOfferLimit = async (userId) => {
  if (!userId) return false;
...
export const checkMessageLimit = async (userId) => {
  if (!userId) return false;
...
export const checkImageLimit = async (userId, newImageCount = 1) => {
...
export const checkFeaturedLimit = async (userId) => {
  if (!userId) return false;
...
export const checkFileAttachmentLimit = async (userId, fileCount = 1) => {
